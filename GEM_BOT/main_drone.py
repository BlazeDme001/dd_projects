...
def main():
    ...
    try:
        ...
        pass
    # result_df = pd.read_csv('csv_files\\bid_data_Drone.csv')
    filtered_df = result_df[result_df['new_itm'].str.contains(r'\bDrone\b', case=False, regex=True)]
    filtered_df.to_csv(os.path.join(os.getcwd(),'csv_files','bid_data_Drone.csv'))
