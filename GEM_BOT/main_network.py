...
def main():
    ...
    bid_search.click()
    bid_search.send_keys('network')
    # bid_search.send_keys('3604726')
    ...
    try:
        ...
        pass
    filtered_df = result_df[result_df['new_itm'].str.contains('network', case=False, regex=False)]
    filtered_df.to_csv(os.path.join(os.getcwd(),'csv_files','bid_data_network.csv'))
    # result_df.to_csv('csv_files\\bid_data_network.csv')
