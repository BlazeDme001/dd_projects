...
def main():
    ...
    bid_search.click()
    bid_search.send_keys('surveillance')
    ...
    try:
        ...
        pass
    filtered_df = result_df[result_df['new_itm'].str.contains('surveillance', case=False, regex=False)]
    filtered_df.to_csv(os.path.join(os.getcwd(),'csv_files','bid_data_surveillance.csv'))
