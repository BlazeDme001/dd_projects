...
def main():
    ...
    try:
        ...
        pass
    filtered_df = result_df[result_df['new_itm'].str.contains('switch', case=False, regex=False)]
    filtered_df.to_csv(os.path.join(os.getcwd(),'csv_files','bid_data_switch.csv'))
