...
def main():
    ...
    # except:
    #     try:
    #         total_pages = driver.find_element(By.XPATH, '//*[@id="light-pagination"]/a[5]')
    #         tp = total_pages.text
    #     except:
    #         tp = 1
    count = 7
    ...
    try:
        ...
        pass
    # result_df = pd.read_csv('csv_files\\bid_data_UAV.csv')
    filtered_df = result_df[result_df['new_itm'].str.contains(r'\bUAV\b', case=False, regex=True)]
    filtered_df.to_csv(os.path.join(os.getcwd(),'csv_files','bid_data_UAV.csv'))
