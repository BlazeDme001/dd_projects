...
def andamantenders_nicgep_tenders_main(key_word):
    others.delete_folder(download_folder=download_folder)
    name = 'AndamanTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://eprocure.andaman.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://eprocure.andaman.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
...
def aptenders_nicgep_tenders_main(key_word):
    others.delete_folder(download_folder=download_folder)
    name = 'AndamanTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://eprocure.andaman.gov.in/'
    ...
    driver.get('https://arunachaltenders.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def assamtenders_gov_tenders_main(key_word):
    others.delete_folder(download_folder=download_folder)
    name = 'assamtenders_gov_tenders'
    print(f'Starting the bot {name}')
    ...
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://assamtenders.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Centerl_GOV_BOT_main(key_word):
    others.delete_folder(download_folder=download_folder)
    name = 'Centerl GOV BOT'
    print(f'Starting the bot {name}')
...
def CHDTenders_GOV_NICGEP_BOT_main(key_word):
    others.delete_folder(download_folder=download_folder)
    name = 'CHDTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://etenders.chd.nic.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://etenders.chd.nic.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Coalindiatenders_NIC_Nicgep_BOT_main(key_word):
    others.delete_folder(download_folder=download_folder)
    name = 'Coalindiatenders NIC Nicgep BOT'
    print(f'Starting the bot {name}')
    link = 'https://coalindiatenders.nic.in/nicgep/app'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://coalindiatenders.nic.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Cpcletenders_NIC_Nicgep_BOT_main(key_word):
    others.delete_folder(download_folder=download_folder)
    name = 'Cpcletenders NIC Nicgep BOT'
    print(f'Starting the bot {name}')
    link = 'https://cpcletenders.nic.in/nicgep/app'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://cpcletenders.nic.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
...
def DadrahaveliTenders_GOV_NICGEP_BOT_main(key_word):
    others.delete_folder(download_folder=download_folder)
    name = 'DadrahaveliTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://dnhtenders.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://dnhtenders.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Defproc_Nicgep_BOT_main(key_word):
    others.delete_folder(download_folder=download_folder)
    name = 'Defproc Nicgep BOT'
    print(f'Starting the bot {name}')
    link = 'https://defproc.gov.in/nicgep/app/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://defproc.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def DelhiTenders_GOV_NICGEP_BOT_main(key_word):
    others.delete_folder(download_folder=download_folder)
    name = 'DelhiTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://govtprocurement.delhi.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://govtprocurement.delhi.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
