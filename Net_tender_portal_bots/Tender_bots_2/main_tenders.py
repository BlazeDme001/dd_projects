...
def Eproc_Rajasthan_GOV_BOT_main(key_word):
    name = 'Eproc Rajasthan GOV BOT'
    print(f'Starting the bot {name}')
    link = 'https://eproc.rajasthan.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://eproc.rajasthan.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
            ...
            if i or i != " ":
                ...
                if match:
                    ...
                    try:
                        ...
                        remarks = 'Unable to get the tender data from the portal, Please insert manually.'
                        manual_insert(t_id, remarks)
...
def Eprocure_Epublish_BOT_main(key_word):
    name = 'Eprocure Epublish BOT'
    print(f'Starting the bot {name}')
    link = 'https://eprocure.gov.in/epublish/app'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://eprocure.gov.in/epublish/app;jsessionid=E29E64015A34144265732B51321149FE.epubgep2?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
            ...
            if i or i != " ":
                ...
                if match:
                    ...
                    try:
                        ...
                        manual_insert(t_id, remarks, name, link)
                        back_btn = driver.find_element(By.XPATH,'//*[@id="DirectLink_9"]')
                        back_btn.click()
                        continue
...
def Eprocurebel_Nicgep_BOT_main(key_word):
    name = 'Eprocurebel Nicgep BOT'
    print(f'Starting the bot {name}')
    link = 'https://eprocurebel.co.in/nicgep/app'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://eprocurebel.co.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Eprocuregrse_Nicgep_BOT_main(key_word):
    name = 'Eprocuregrse Nicgep BOT'
    print(f'Starting the bot {name}')
    link = 'https://eprocuregrse.co.in/nicgep/app'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://eprocuregrse.co.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Eprocuregsl_Nic_Nicgep_BOT_main(key_word):
    name = 'Eprocuregsl Nic Nicgep BOT'
    print(f'Starting the bot {name}')
    link = 'https://eprocuregsl.nic.in/nicgep/app'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://eprocuregsl.nic.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Eprocurehsl_Nicgep_BOT_main(key_word):
    name = 'Eprocurehsl Nicgep BOT'
    print(f'Starting the bot {name}')
    link = 'https://eprocurehsl.nic.in/nicgep/app'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://eprocurehsl.nic.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Eprocuremdl_Nic_Nicgep_BOT_main(key_word):
    name = 'Eprocuremdl Nic Nicgep BOT'
    print(f'Starting the bot {name}')
    link = 'https://eprocuremdl.nic.in/nicgep/app'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://eprocuremdl.nic.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Eprocurentpc_Nic_Nicgep_BOT_main(key_word):
    name = 'Eprocurentpc Nic Nicgep BOT'
    print(f'Starting the bot {name}')
    link = 'https://eprocurentpc.nic.in/nicgep/app'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://eprocurentpc.nic.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Etenders_GOV_BOT_main(key_word):
    name = 'Etenders GOV BOT'
    print(f'Starting the bot {name}')
    link = 'https://etenders.gov.in/eprocure/app'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://etenders.gov.in/eprocure/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Etenders_UP_NIC_BOT_main(key_word):
    name = 'Etenders UP NIC BOT'
    print(f'Starting the bot {name}')
    link = 'https://etender.up.nic.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://etender.up.nic.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
