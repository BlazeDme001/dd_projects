...
def GoaTenders_GOV_NICGEP_BOT_main(key_word):
    name = 'GoaTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://eprocure.goa.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://eprocure.goa.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
...
def HPtenders_GOV_NICGEP_BOT_main(key_word):
    name = 'HPtenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://hptenders.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://hptenders.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def HRYtenders_GOV_NICGEP_BOT_main(key_word):
    name = 'HRYtenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://etenders.hry.nic.in/nicgep/app'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://etenders.hry.nic.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Iocletenders_NIC_Nicgep_BOT_main(key_word):
    name = 'Iocletenders_NIC Nicgep BOT'
    print(f'Starting the bot {name}')
    link = 'https://iocletenders.nic.in/nicgep/app'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://iocletenders.nic.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
                ...
                if match:
                    ...
                    try:
                        ...
                        try:
                            ...
                            emd = driver.find_element(By.XPATH, '//*[@id="content"]/table/tbody/tr[2]/td/table/tbody/tr/td[2]/table/tbody/tr[4]/td/table[2]/tbody/tr/td/table/tbody/tr[9]/td/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody/tr[1]/td[2]').text.replace(',', '')
                        try:
                            pbm_date = driver.find_element(By.XPATH, '//*[@id="content"]/table/tbody/tr[2]/td/table/tbody/tr/td[2]/table/tbody/tr[4]/td/table[2]/tbody/tr/td/table/tbody/tr[17]/td/table/tbody/tr[8]/td[4]').text
                        except:
                            pbm_date = driver.find_element(By.XPATH, '//*[@id="content"]/table/tbody/tr[2]/td/table/tbody/tr/td[2]/table/tbody/tr[4]/td/table[2]/tbody/tr/td/table/tbody/tr[14]/td/table/tbody/tr[8]/td[4]').text
...
def J_KTenders_GOV_NICGEP_BOT_main(key_word):
    name = 'J&KTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://jktenders.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://jktenders.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def JKDTenders_GOV_NICGEP_BOT_main(key_word):
    name = 'JKDTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://jharkhandtenders.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://jharkhandtenders.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def KeralaTenders_GOV_NICGEP_BOT_main(key_word):
    name = 'KeralaTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    ...
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://etenders.kerala.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def LEHTenders_GOV_NICGEPBOT_main(key_word):
    name = 'LEHTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://tenders.ladakh.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://tenders.ladakh.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def LKDPTenders_GOV_NICGEP_BOT_main(key_word):
    name = 'LKDPTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://tendersutl.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://tendersutl.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Mahatenders_GOV_BOT_main(key_word):
    name = 'Mahatenders GOV BOT'
    print(f'Starting the bot {name}')
    ...
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://mahatenders.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
