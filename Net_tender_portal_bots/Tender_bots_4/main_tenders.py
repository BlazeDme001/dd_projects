...
def ManipurTenders_GOV_NICGEP_BOT(key_word):
    name = 'ManipurTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://manipurtenders.gov.in/'
    logger.info('='*100)
...
def MeghTenders_GOV_NICGEP_BOT_main(key_word):
    name = 'MeghTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://meghalayatenders.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://meghalayatenders.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def MizoramTenders_GOV_NICGEP_BOT_main(key_word):
    name = 'MizoramTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://mizoramtenders.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://mizoramtenders.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Mptenders_GOV_BOT_main(key_word):
    name = 'Mptenders GOV BOT'
    print(f'Starting the bot {name}')
    link = 'https://mptenders.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://mptenders.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def NagalandTenders_GOV_NICGEP_BOT_main(key_word):
    name = 'NagalandTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://nagalandtenders.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://nagalandtenders.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Pmgsytenders_GOV_Nicgep_BOT_main(key_word):
    name = 'Pmgsytenders GOV Nicgep BOT'
    print(f'Starting the bot {name}')
    link = 'https://pmgsytenders.gov.in/nicgep/app'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://pmgsytenders.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def PuducherryTenders_GOV_NICGEP_BOT_main(key_word):
    name = 'PuducherryTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://pudutenders.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://pudutenders.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def PBTenders_GOV_NICGEP_BOT_main(key_word):
    name = 'PBTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://eproc.punjab.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://eproc.punjab.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def SikkimTenders_GOV_NICGEP_BOT_main(key_word):
    name = 'SikkimTenders GOV NICGEP BOT'
    print(f'Starting the bot {name}')
    link = 'https://sikkimtender.gov.in/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
    driver.get('https://sikkimtender.gov.in/nicgep/app?page=FrontEndAdvancedSearch&service=page')
    tender_type = driver.find_element(By.XPATH, '//*[@id="TenderType"]/option[2]')
    tender_type.click()
    tender_search_press = driver.find_element(By.XPATH, '//*[@id="workItemTitle"]')
    tender_search_press.click()
...
def Tendersodisha_GOV_BOT_main(key_word):
    name = 'Tendersodisha GOV BOT'
    print(f'Starting the bot {name}')
    link = 'https://tendersodisha.gov.in/nicgep/app/'
    logger.info('='*100)
    logger.info(f'Starting the bot {name}')
    # driver = webdriver.Chrome(ChromeDriverManager().install(), options=chrome_options)
    driver = webdriver.Chrome(options=chrome_options)
